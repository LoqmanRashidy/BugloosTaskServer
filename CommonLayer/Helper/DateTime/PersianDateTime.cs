        ...
        IEquatable<PersianDateTime>, IEquatable<DateTime>
    {
            ...
            : this()
        {
            if (!nullableDateTime.HasValue)
            {
                ...
                //_dateTime = pc.ToDateTime(pc.GetYear(nullableDateTime),
                //   pc.GetMonth(nullableDateTime),
                //     pc.GetDayOfMonth(nullableDateTime),
                //       pc.GetHour(nullableDateTime),
                //          pc.GetMinute(nullableDateTime),
                //           pc.GetSecond(nullableDateTime), 0);
        ...
        public string PersianDateTime2(DateTime nullableDateTime)
        {
            ...
            PersianCalendar pc = new PersianCalendar();
            var date = pc.ToDateTime(pc.GetYear(nullableDateTime),
               pc.GetMonth(nullableDateTime),
                 pc.GetDayOfMonth(nullableDateTime),
                   pc.GetHour(nullableDateTime),
                      pc.GetMinute(nullableDateTime),
